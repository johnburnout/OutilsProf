...
% ============================================================
\section{Lignes de réponse}
% ============================================================

\subsection{Ligne de longueur par défaut (6\,cm)}

Le résultat est \reponse.

\subsection{Ligne de longueur personnalisée}

La réponse complète : \reponse[4cm].

\subsection{Ligne sur toute la largeur}

\grandeReponse

\subsection{Ligne sur une fraction de la largeur}

\grandeReponse[0.5]

\subsection{Combinaison avec d'autres outils}

\begin{methode}
    Pour calculer l'aire d'un rectangle de longueur 8\,cm et de
    largeur 5\,cm, on applique la formule $A = L \times l$.
\end{methode}

Aire du rectangle : \reponse[3cm]\,cm\textsuperscript{2}.
